...
type (
	...
	HandlerFunc func(context.Context, Delivery) error
...
func (b *Broker) connect() error {
	...
	go b.reconnect(b.ch.NotifyClose(errCh))
...
func (b *Broker) consume(delvCh <-chan amqp.Delivery, handler HandlerFunc) {
	defer b.wg.Done()
	for d := range delvCh {
...
func (b *Broker) ShutDownConsumersForQueues(queueNames []string) []error {
